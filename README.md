...
<p align="left">I am a Cyber Security Enthusiast and a Certified Ethical Hacker with a passion for cybersecurity and technology. Completed my BTech in Computer Science with a specialization in Cybersecurity at VIT. I enjoy working on projects that involve cybersecurity tools, ethical hacking, and software development.</p>

<h3 align="left">Skills:</h3>
<ul>
  <li><strong>Programming Languages:</strong> Python, Java, SQL</li>
  <li><strong>Tools & Technologies:</strong> Microsoft Suite, UNIX & Linux, SailPoint, Burp Suite, Wireshark, Nmap, Splunk, Azure Cloud Defense, Nessus Essentials, IBM QRadar, VMware</li>
